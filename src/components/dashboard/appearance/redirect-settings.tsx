...
export function RedirectSettings({ flags, settings }: RedirectSettingsProps) {
  ...
  const [enabled, setEnabled] = useState(!!settings.redirect_url)
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Redirecionar visitantes temporariamente
              </p>
            </div>
            <Switch
              checked={enabled}
            ...
            <>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  name="redirect_until"
                  type="datetime-local"
                  defaultValue={formatDatetimeLocal(redirectUntil) || getDefaultDatetime()}
                />
